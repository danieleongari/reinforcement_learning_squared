"""Duelling Double Deep Q-Learning Network (DQN) for CartPole (HoML pag 641)."""
import os
...
# Deep Model: NEW for Duelling DQN, to allow for the subtraction of the max predicted advantage from all predicted advantages
...
advantages = raw_advantages - K.max(raw_advantages, axis=1, keepdims=True) # NEW!
Q_values = state_values + advantages
train_model = keras.Model(inputs=[input_states], outputs=[Q_values])
